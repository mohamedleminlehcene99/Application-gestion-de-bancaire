...
import { changerRoleUser } from '../fn/user/changer-role-user';
import { ChangerRoleUser$Params } from '../fn/user/changer-role-user';
...
export class UserService extends BaseService {
  ...
  /** Path part for operation `changerRoleUser()` */
  static readonly ChangerRoleUserPath = '/users/changer/user/role';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `changerRoleUser()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  changerRoleUser$Response(params: ChangerRoleUser$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
    return changerRoleUser(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `changerRoleUser$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  changerRoleUser(params: ChangerRoleUser$Params, context?: HttpContext): Observable<void> {
    return this.changerRoleUser$Response(params, context).pipe(
  ...
  static readonly ValidateAccountPath = '/users/validate/account/{user_id}';
  ...
  static readonly InvalidateAccountPath = '/users/invalidate/account/{user_id}';
  ...
  static readonly FindUserByIdPath = '/users/{user_id}';
  ...
  static readonly DeletePath = '/users/{user_id}';
